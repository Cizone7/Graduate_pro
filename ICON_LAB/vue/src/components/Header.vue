<template>
  <div style="line-height: 60px; display: flex" :class="`${themes[themeStatus]} theme`">
    <div style="flex: 1;">
    ...
    <div style="width: 220px; color: white ; font-size: 14px; display: flex;align-items: center; margin-right: 20px">北京时间： {{ time }}</div>
